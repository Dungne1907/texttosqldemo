...
const I18N_STRINGS = {
    vi: {
        ...
        gateGuideStep3: "Chọn nhà cung cấp API (DeepSeek hoặc Gemini), nhập câu hỏi tiếng Việt; toàn bộ dòng đã nạp trong mỗi bảng được gửi kèm yêu cầu (dataset rất lớn có thể chạm giới hạn kích thước gói tin).",
        gateGuideStep4: "Enter gửi tin nhắn, Shift+Enter xuống dòng.",
        gateGuideOk: "OK — Vào ứng dụng",
        titlePage: "Data Chat — Gemini / DeepSeek",
        appTitle: "Data Chat",
        apiLabel: "API:",
        sqlPipelineToggle: "Few-shot SQL + chạy trên DB cục bộ",
        sqlHeading: "Câu truy vấn SQL",
        sqlResultHeading: "Kết quả truy vấn",
        sqlExecError: "Lỗi khi chạy SQL: {msg}",
        sqlParseError: "Mô hình không trả về JSON hợp lệ { \"sql\", \"explanation\" }.",
        sqlUnsafeSql: "Chỉ cho phép một câu SELECT (không DDL/DML khác).",
        sqlTruncatedRows: "Hiển thị {shown} / {total} dòng.",
        sqlEmptyResult: "(Không có dòng trả về)",
        ...
        newChatBtn: "Chat mới",
        untitledChat: "Chat mới",
        historyOpenHint: "Mở cuộc trò chuyện",
        ...
        dbTableUsers: "SinhVien",
        dbTableOrders: "ThanhToan",
        dbTableProducts: "MonHoc",
        ...
        welcomeSystem:
            "Chào bạn! Mặc định bật « Few-shot SQL »: API chỉ nhận schema + khoảng 10 dòng mẫu và thống kê aggregates; câu SQL chạy trên toàn bộ dữ liệu trong trình duyệt nên kết quả số liệu khớp CSDL. Tắt tùy chọn nếu bạn muốn chat tự do (dễ sai với bảng lớn).",
        pickFileFirst: "Chọn một file .csv hoặc .zip trước.",
        invalidExtension: "Chỉ chấp nhận file .csv, .zip, .db hoặc .sqlite.",
        ...
        fileTooLarge: "File quá lớn (tối đa {size}).",
        fileAttached: "Đã đính kèm: {name} (nội dung file không được gửi lên AI).",
        dbViewerTitle: "Xem toàn bộ dữ liệu",
        dbViewerBtn: "Xem toàn bộ",
        dbSearchPlaceholder: "Tìm kiếm trong bảng...",
        dbNoResults: "Không tìm thấy kết quả phù hợp",
        dbNoData: "Bảng này chưa có dữ liệu",
        dbPage: "Trang {page} / {total}",
        dbRows: "{count} dòng",
        dbRowsFiltered: "{filtered} / {total} dòng",
        historyClickHint: "Nhấn để điền lại câu hỏi",
    },
    en: {
        ...
        gateGuideStep3:
            "Pick an API provider (DeepSeek or Gemini), type your question in Vietnamese; all loaded rows per table are included in the request (very large datasets may hit the request size limit).",
        gateGuideStep4: "Enter sends the message, Shift+Enter adds a new line.",
        gateGuideOk: "OK — Enter app",
        titlePage: "Data Chat — Gemini / DeepSeek",
        appTitle: "Data Chat",
        apiLabel: "API:",
        sqlPipelineToggle: "Few-shot SQL + run locally",
        sqlHeading: "SQL query",
        sqlResultHeading: "Query result",
        sqlExecError: "SQL execution error: {msg}",
        sqlParseError: "Model did not return valid JSON { \"sql\", \"explanation\" }.",
        sqlUnsafeSql: "Only a single SELECT is allowed (no DDL/other DML).",
        sqlTruncatedRows: "Showing {shown} / {total} rows.",
        sqlEmptyResult: "(No rows returned)",
        ...
        historyOpenHint: "Open conversation",
        ...
        welcomeSystem:
            "Welcome! « Few-shot SQL » is on by default: the API only gets schema, ~10 random sample rows, and aggregates; SQL runs on the full dataset in your browser so numbers match the database. Turn it off only if you want free-form chat (can be wrong on large tables).",
        pickFileFirst: "Choose a .csv or .zip file first.",
        invalidExtension: "Only .csv, .zip, .db, or .sqlite files are accepted.",
        ...
        fileAttached: "Attached: {name} (file content is not sent to AI).",
        dbViewerTitle: "View Full Database",
        dbViewerBtn: "View All",
        dbSearchPlaceholder: "Search in table...",
        dbNoResults: "No matching results found",
        dbNoData: "This table has no data yet",
        dbPage: "Page {page} / {total}",
        dbRows: "{count} rows",
        dbRowsFiltered: "{filtered} / {total} rows",
        historyClickHint: "Click to fill question",
    },
};
